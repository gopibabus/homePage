...
<body>
    ...
    <h1 class="text-center display-3 text-light border-bottom border-danger pb-4 mt-3">🛠️ Projects Under Progress 🚧
    </h1>
    <div class="container">
        <div class="row mt-4">
            <div class="col-md-6 mt-5">
                ...
                <a href="https://gopibabu-react.netlify.app" target="_blank"
                ...
                <a href="https://flix.gopibabu.live" target="_blank"
                ...
                <a href="https://gopibabu-devtools.netlify.app" target="_blank"
            ...
            <div class="col-md-6 mt-5">
                <a href="https://portfolio.gopibabu.live" target="_blank"
                    class="btn btn-lg btn-primary form-control font-weight-bold mb-3">PORTFOLIO</a>
                <a href="https://blog.gopibabu.live" target="_blank"
                    class="btn btn-lg btn-info form-control font-weight-bold mb-3">BLOG</a>
                <a href="https://assets.gopibabu.live" target="_blank"
