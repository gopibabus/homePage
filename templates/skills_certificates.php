<section class="ftco-section ftco-no-pb goto-here" id="resume-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div id="page-2" class="page three">
                    ...
                    <div class="row progress-circle mb-5">
                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="bg-white rounded-lg shadow p-4">
                                ...
                                <div class="row text-center mt-4">
                                    <div class="col-6 border-right">
                                        <div class="h4 font-weight-bold mb-0">35%</div><span
                                            class="small text-gray">Last week</span>
                                    </div>
                                    <div class="col-6">
                                        <div class="h4 font-weight-bold mb-0">70%</div><span
                                            class="small text-gray">Last month</span>
                                    </div>
                                </div>
                                <!-- END -->
                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="bg-white rounded-lg shadow p-4">
                                ...
                                <div class="row text-center mt-4">
                                    ...
                                    <div class="col-6">
                                        <div class="h4 font-weight-bold mb-0">50%</div><span
                                            class="small text-gray">Last month</span>
                                    </div>
                                </div>
                                <!-- END -->
                ...
                <div id="page-3" class="page four">
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <span class="position">Scrum Alliance</span>
                            <p>A scrum master is the facilitator for an Agile development team; they are responsible for
                                managing the exchange of information between team members.
                                Scrum is a methodology that allows a team to self-organize and make changes quickly, in
                                accordance with Agile principles..</p>
                        </div>
                    </div>
                    <div class="resume-wrap d-flex ftco-animate">
                        <div class="icon d-flex align-items-center justify-content-center">
                        ...
                        <div class="text pl-3">
                            ...
                            <h2>Certified PHP Engineer</h2>
                            <span class="position">Zend</span>
                            <p>The Zend Certified PHP Engineer is an industry-wide standard that recognizes PHP
                                expertise and is a measure of distinction that employers use to evaluate prospective
                                employees. </p>
                        </div>
                    </div>
                </div>
